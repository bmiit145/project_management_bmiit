...
<head>
    ...
    <title>Change Password | BMIIT PROJECTS</title>
            ...
            <div class="card">
                <div class="card-body">
                  ...
                  <span class="app-brand-logo demo">
                    ...
                    <p class="mb-4">for {{$username }}</p>

                    <form id="formAuthentication" class="mb-3" action="{{route('change.password.new')}}" method="POST">
                        @csrf
...
<script>
    $('#formAuthentication').submit(function (event) {
        ...
        if (old_password == '' || password == '' || old_password == null || password == null){
