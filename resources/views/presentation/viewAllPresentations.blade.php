...
@section('body')
    ...
    <div class="row">
            ...
            <div class="col-xl">
                <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="mb-0"> Panel Allocation</h5>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card">
                    <h5 class="card-header "><strong> Allocated Panel List</strong></h5>
                    ...
                    <div class="card-datatable  table-responsive text-nowrap p-2">
                        ...
                        <table class="table table-hover table-responsive dataTable text-nowrap"
                            ...
                            @if (count($panelProjects) != 0)
                                @foreach ( $panelProjects as $key => $panelProject)
                                    <tr>
                                        <td>
                                            <strong>{{ ++$key }}</strong>
                                        </td>
                                        <td>
                                            <strong>{{ $panelProject->panel->number}}</strong>
                                        </td>
                                        <td>
                                            <strong>{{ $panelProject->group->number  }}</strong>
                                        </td>
                                        <td>
                                            <strong>{{ $panelProject->presentationPanel->courseYear->course->name }}</strong>
                                        </td>

                                        <td>
                                            <strong>{{ $panelProject->presentationPanel->courseYear->year->name }}</strong>
                                        </td>
